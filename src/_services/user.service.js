...
var sender_name = 'Agil'//Config.sms.sender_name;
var gateway_id = 140//Config.sms.gateway_id;
...
function login(phone, phone_prefix) {
    ...
    return fetch(`${ApiConfigs.base_url+ApiConfigs.accounts.login}`, requestOptions).then(handleResponse);
}
...
function verify(user) {
    ...
    return fetch(`${ApiConfigs.base_url+ApiConfigs.accounts.verify}`, requestOptions)
        .then(handleResponse)
        .then(user => {
